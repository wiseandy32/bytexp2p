...
const reviews = [
  {
    text: "Exchange fees are reasonable, support responses are super fast. I consider Peershieldex the best place for your escrow crypto exchange.",
    author: "Ander Hilson - Twitter",
  },
  {
    text: "You can swap as many crypto as possible. Its awesome to use Peershieldex for your escrow swaps. The support is also very active and handling issues.",
    author: "Garry David - Discord",
  },
  {
    text: "Been using Peershieldex for some time now. Had a little issue once but the support responded and rectified it immediately. I'll recommend Peershieldex to anyone, anytime. The escrow process is simple and very efficient.",
...
const FaqItem = ({ question, answer }: FaqItemProps) => {
  ...
  return (
    <div className="bg-dark-bg3 rounded-xl p-4 mb-4 border border-gray-700">
      ...
      {isOpen && (
        <div className="mt-2">
          <p className="text-gray-400 text-sm" dangerouslySetInnerHTML={{ __html: answer }}></p>
        </div>
      )}
    </div>
  );
    ...
    <section className="bg-dark-bg5 py-5">
      <div className="container mx-auto px-6">
            ...
            {reviews.map((review, index) => (
              <div key={index} className="flex-shrink-0 w-full sm:w-2/3">
                <div className="bg-dark-bg3 rounded-xl p-6 border border-gray-700">
                  <div className="flex">
                    <img src="https://peershieldex.com/assets/images/comment.png" alt="" className="w-12 h-12" />
                    <div className="ml-4">
        ...
        <div className="hidden md:grid grid-cols-1 md:grid-cols-3 gap-8">
          {reviews.map((review, index) => (
            <div key={index} className="bg-dark-bg3 rounded-xl p-6 border border-gray-700">
              <div className="flex">
                <img src="https://peershieldex.com/assets/images/comment.png" alt="" className="w-12 h-12" />
                <div className="ml-4">
                  <p className="text-sm text-gray-400">
        ...
        <div className="mt-20">
          <h2 className="text-3xl font-bold text-center mb-12">FAQs on Exchange</h2>
