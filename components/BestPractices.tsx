...
const practices = [
  {
    ...
    description:
      "To make sure you take full advantage of the cryptocurrency market, we offer a respectable transaction speed.",
    aosDuration: "400",
  },
  {
  ...
  },
  {
    ...
    description:
      "We offer very low exchange fees. Completely flexible rates to allow smooth transaction between trade parties.",
    aosDuration: "400",
  },
  {
    ...
    description:
      "To prevent disagreements between traders, we handle trades using automated procedures and multi-signature transaction processes.",
    aosDuration: "600",
  },
];
  ...
  return (
    <div className="w-full py-20 anuphan relative overflow-hidden">
      <div className="container mx-auto py-4 px-4 sm:px-0">
        ...
        >
          <h1 className="anuphan-2 text-4xl font-bold">
            A New World of Crypto Exchange
          </h1>
