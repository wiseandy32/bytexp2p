  ...
  return (
    <section className="bg-dark-bg3 py-20 sans-pro">
      <div className="container mx-auto px-4">
        ...
        >
          <p className="text-sm text-green-500 m-0">
            Start and complete Escrow in 3-easy steps.
          </p>
          <h1 className="text-white text-4xl font-bold">
            Securely Exchange crypto assets in minutes
          </h1>
        </div>
            ...
            <div className="relative">
              <div className="flex items-start mb-8">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 bg-dark-bg4 p-3 rounded-md">
                    Proceed to create the exchange room. Share your exchange ID
                    with a trade partner to join them to the trade.
                  </p>
                </div>
              </div>
              <div className="flex items-start mb-8">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 bg-dark-bg4 p-3 rounded-md">
                    Complete the exchange with just a click. Join existing
                    trades or created exchange room are all seamlessly
                    optimized.
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 bg-dark-bg4 p-3 rounded-md">
                    Once the exchange is complete, Instantly Withdraw your
                    exchanged asset to your preferred crypto address.
                  </p>
                </div>
              </div>
            </div>
