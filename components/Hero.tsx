      ...
      <div className="grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-gray-400 mb-8">
            Bytexp2p supports 60+ assets, ensuring a professional and seamless
        ...
        <div className="relative">
          <div className="relative z-10 bg-gray-800 border border-gray-700 rounded-2xl p-6 shadow-2xl">
            ...
            <div>
              ...
              <div className="bg-gray-900 p-3 rounded-lg flex justify-between items-center">
                <div className="flex items-center bg-gray-800 px-3 py-2 rounded-md">
                  <img src="/btc.svg" alt="BTC" className="w-5 h-5 mr-2" />
            ...
            <div className="mt-4">
              ...
              <div className="bg-gray-900 p-3 rounded-lg flex justify-between items-center">
                <div className="flex items-center bg-gray-800 px-3 py-2 rounded-md">
                  <img src="/trx.svg" alt="TRX" className="w-5 h-5 mr-2" />
            ...
            <div className="mt-6 text-sm">
              <div className="flex justify-between mb-2">
                ...
                <span>
                  0.017 <span className="font-bold text-gray-500">BTC</span>
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-400">Est. Value</span>
                <span>
                  0.317 <span className="font-bold text-gray-500">BTC</span>
                </span>
              </div>
            </div>

            <button
              className="w-full mt-6 bg-new-blue text-white font-bold py-3 rounded-lg hover:bg-new-blue-dark transition-colors"
              disabled
            >
              Continue
            </button>
