...
const TrustedGlobally = () => {
  return (
    <div className="bg-dark-bg3 py-20 font-sans-pro">
      <div className="container mx-auto px-4 sm:px-0">
        <div className="mb-5">
          <h5
            className="text-gray-400 text-lg aos-init aos-animate"
            data-aos="fade-up"
          ...
          <h2
            className="text-white text-4xl font-bold aos-init aos-animate"
            data-aos="fade-up"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            {timelineItems.map((item, index) => (
              <div
                className="timeline-wrapper mt-3 flex items-start"
                key={index}
              >
                <div>
                ...
                <div className="bg-dark-bg4 rounded-lg ml-4 p-3">
                  <p className="text-sm text-gray-400 m-0">{item.text}</p>
                </div>
              </div>
            ))}
          </div>
            ...
            <div className="text-center p-4 bg-dark-bg4 rounded-lg h-full">
              ...
              <div className="mt-3">
                ...
                <p
                  ...
                  data-aos-duration="700"
                >
                  Our support assistance staffs are available 24 hours a day to
                  help you for trading or answer any other question you might
                  have.
                </p>
              </div>
            </div>
