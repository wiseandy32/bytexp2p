      ...
      <div className="max-w-md mx-auto">
        <div className="mb-5 mt-4">
          ...
          <small className="text-xs text-gray-400 block mt-2">
            Please upload a screenshot of the transaction receipt OR give the
            transaction hash as evidence that the payment was successful.
          </small>
        </div>
        <div className="bg-gray-800 rounded-md p-4">
          ...
          <form onSubmit={handleSubmit}>
            <div className="p-lg-4">
              ...
              <div className="mt-4">
                ...
                <input
                  ...
                  required
                />
                <small className="text-xs d-block text-gray-500 mt-1">
            ...
            <div className="p-4 border-t border-gray-700">
              <button
                type="submit"
                className="py-2 px-4 bg-blue-600 hover:bg-blue-700 rounded-md font-bold text-xs"
                disabled={loading}
              >
