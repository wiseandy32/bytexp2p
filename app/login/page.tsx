      ...
      <div className="container mx-auto py-10 px-4 sm:px-0">
        <div className="max-w-md mx-auto mt-24 bg-dark-bg5 p-8 rounded-lg">
          ...
          <form>
            ...
            <button type="submit" className="w-full bg-new-blue hover:bg-new-blue-dark text-white font-bold py-2 px-4 rounded-md transition-colors">Login</button>

            <div className="flex items-center my-6">
              <div className="flex-grow border-t border-gray-700"></div>
              <span className="flex-shrink mx-4 text-gray-400 text-sm">Don't have an account? <Link href="/register" className="text-green-500">Create account</Link></span>
              <div className="flex-grow border-t border-gray-700"></div>
            </div>
