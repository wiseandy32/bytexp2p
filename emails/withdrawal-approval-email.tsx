...
export const WithdrawalApprovalEmail: React.FC<Readonly<WithdrawalApprovalEmailProps>> = ({
  name,
  amount,
  coin,
  date,
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={text}>
            Your recent withdrawal has been approved and the funds have been sent to your wallet address. Below is the details of the transaction:
          </Text>
          <table style={table}>
            <tbody>
              <tr style={tableRow}>
